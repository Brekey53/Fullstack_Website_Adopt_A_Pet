...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function carregarAnimais() {
        try {
            ...
            // Limpar o select
            selectAnimal.innerHTML = '<option value="" selected disabled>Escolha um patudo...</option>';
            selectAnimal.innerHTML += '<option value="0">Qualquer animal (Sem preferência)</option>';
            ...
            animais.forEach(animal => {
                ...
                if(animal.disponivel) {
                    ...
                    option.textContent = `${animal.nome} (${animal.porte})`;
            ...
            console.error(error);
            selectAnimal.innerHTML = '<option disabled>Erro ao carregar lista</option>';
        }
    }
    ...
    btnConfirmar.addEventListener("click", async function () {
        ...
        try {
            ...
            btnConfirmar.innerHTML = '<i class="fa fa-spinner fa-spin"></i> A processar...';
            ...
            if (!resposta.ok) {
                ...
                throw new Error(resultado.mensagem || "Erro no processamento");
            }
